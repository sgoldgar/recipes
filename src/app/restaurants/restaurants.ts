...
const restaurants: Restaurant[] = [
    ...
    {name: "Slackers", categories: ['drinks', 'beer', 'kid friendly'], location: 'North', menu: 'https://www.slackersbrewing.com/'},
    ...
    {name: "Casper Fermentables", categories: ['brunch', 'bakery'], location: 'South', menu: 'http://www.casperfermentables.com/'},
    ...
    {name: "Central Machine Works", categories: ['coffeeshop', 'patio', 'dog friendly', 'kid friendly'], location: 'East Side', menu: 'https://www.cmwbeer.com/menu'},
    ...
    {name: "Enchiladas Y Mas", categories: ['mexican'], location: 'North', menu: 'http://www.enchiladasymas.com/files/117889810.pdf'},
    {name: "Nissi Vegan Mexican Cuisine", categories: ['mexican'], location: 'North', menu: 'http://nissivegmex.com/'},
    {name: "Blue Corn Harvest", categories: ['mexican'], location: 'Cedar Park', menu: 'http://www.bluecornharvest.com/'},
    ...
    {name: "Sip Saam Thai", categories: ['thai'], location: 'North', menu: 'https://www.thailadaatx.com/'},
    {name: "Chaba Thai", categories: ['thai', 'foodtruck'], location: 'North', menu: 'https://chaba.kitchen/'},
    {name: "Madam Mam's", categories: ['thai'], location: 'North', menu: 'http://www.madammam.com/'},
    {name: "Titaya", categories: ['thai'], location: 'Central', menu: 'http://titayasthaicuisine.com/'},
    {name: "Sway", categories: ['thai', 'fancy', 'happy hour food'], location: 'North', menu: 'https://swaythai.com/'},
    ...
    {name: "MezzeMe", categories: ['mediterranean'], location: 'Central', menu: 'https://www.mezzeme.com/menu'},
    ...
    {name: "Levant Cafe", categories: ['mediterranean'], location: 'Cedar Park', menu: 'http://levantgrille.com/'},
    {name: "Falafel Burger", categories: ['mediterranean', 'quick/casual'], location: 'North', menu: 'http://www.falafelburgeraustin.com/'},
    {name: "Caspian Grill", categories: ['mediterranean'], location: 'North', menu: 'http://caspiangrillaustin.com/'},
    ...
    {name: "Hopfields", categories: ['french', 'fancy'], location: 'Central', menu: 'http://hopfieldsaustin.com/'},
    ...
    {name: "Bayleaf", categories: ['indian'], location: 'North', menu: 'http://www.bayleafaustin.com/'},
    ...
    {name: "Sangham Chettinad", categories: ['indian'], location: 'North', menu: 'https://www.sangamchettinad.com/'},
    {name: "Godavari", categories: ['indian'], location: 'North', menu: 'https://godavarius.com/austin'},
    {name: "Desilicious", categories: ['indian'], location: 'North', menu: 'https://www.desiliciouscafe.com/'},
    ...
    {name: "Big City Bagels", categories: ['sandwiches', 'bakery'], location: 'North', menu: 'https://bigcitybagelsandsubs.com/'},
    ...
    {name: "Proud Mary Coffee", categories: ['coffeeshop', 'brunch'], location: 'South 1st/Lamar', menu: 'https://proudmarycoffee.com/pages/proud-mary-cafe-austin'},
    {name: "Bouldin Creek", categories: ['american', 'brunch', 'patio', 'dog friendly'], location: 'South 1st/Lamar', menu: 'https://bouldincreekcafe.com/'},
